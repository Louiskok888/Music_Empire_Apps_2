...
const getServerSideProps = async ({ params  })=>{
    const res = await axios__WEBPACK_IMPORTED_MODULE_2___default().get(`http://localhost:3000/api/orders/${params.id}`);
    return {
        props: {
            order: res.data
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [628,675], () => (__webpack_exec__(1619)));
